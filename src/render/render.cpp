...
void renderHighway(pcl::visualization::PCLVisualizer::Ptr& viewer, const pcl::ModelCoefficients &coefficients)
{
	// double xMin = 0;
	// double xMax = 60;
	// double yMin = -6;
	// double yMax = 6;
	// double zMin = (-coefficients.values[3] - coefficients.values[0]*xMin - coefficients.values[1]*yMin)/coefficients.values[2];
	// double zMax = (-coefficients.values[3] - coefficients.values[0]*xMax - coefficients.values[1]*yMax)/coefficients.values[2];
	viewer->addPlane(coefficients, "drive_plane"); 
...
void renderPointCloud(pcl::visualization::PCLVisualizer::Ptr& viewer, const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud, const std::string& name, const int size, Color color) {
...
void renderPointCloud(pcl::visualization::PCLVisualizer::Ptr& viewer, const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud, const std::string& name, const int size, Color color) {
	if(color.r==-1) {
